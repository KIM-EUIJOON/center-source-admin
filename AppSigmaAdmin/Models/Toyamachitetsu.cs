...
namespace AppSigmaAdmin.Models
{
    public class MPA1601Context
    {
        ...
        /// 決済情報リスト
        /// </summary>
        public MPA1601ReportData PaymentReportData { get; set; }
    ...
    public class MPA1601ReportData
    {
        ///<summary>
        ///総リスト件数
        ///</summary>
    ...
    public class MPA1601ReportDataRow
    {
        /// <summary>
        /// ユーザID
        /// </summary>
    ...
    /// </summary>
    public class ToyamachitetsuPaymentInfo : PaymentInfo
    {
        /// <summary>
        /// チケット種別
        /// </summary>
    ...
    /// 富山地方鉄道乗車券利用情報
    /// </summary>
    public class ToyamachitetsuUsageInsuranceInfo
    {
        /// <summary>
        /// ユーザID
        /// </summary>
